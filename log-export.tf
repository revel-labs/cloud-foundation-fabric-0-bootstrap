...
module "log-export-project" {
  source = "git@github.com:revel-labs/cloud-foundation-fabric-modules.git//project"
...
module "log-export-dataset" {
  source        = "git@github.com:revel-labs/cloud-foundation-fabric-modules.git//bigquery-dataset"
...
module "log-export-gcs" {
  source     = "git@github.com:revel-labs/cloud-foundation-fabric-modules.git//gcs"
...
module "log-export-logbucket" {
  source        = "git@github.com:revel-labs/cloud-foundation-fabric-modules.git//logging-bucket"
...
module "log-export-pubsub" {
  source     = "git@github.com:revel-labs/cloud-foundation-fabric-modules.git//pubsub"
